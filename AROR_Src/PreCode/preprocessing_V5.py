...
## For the 3rd pair, crop the common area of size (1500,1500) 
...
ARmat_path, ORmat_path = '../Data_aug/AR_mat.mat',  '../Data_augOR_mat.mat'
io.savemat(ARmat_path, {'AR':AR_npy})
io.savemat(ORmat_path, {'OR':OR_npy})
